...
async function init(){
    ...
    await fetch("https://raw.githubusercontent.com/Lukeghrhgfhgh/Deleted-Multiliveries/main/Dependencies/Liveries.json").then(res => res.json()).then(data => liveryobj = data)
